...
export default class Bookshelf {
  ...
  constructBookshelf() {
    ...
    svg
      .append("line")
      .attr("x1", 390 * widthScale)
      .attr("y1", 0)
      .attr("x2", 390 * widthScale)
      .attr("y2", height)
      .attr("stroke", "#D7984D")
      .attr("stroke-width", 30 * widthScale);

    // Create the left shelf wall (on the right)
    svg
      .append("line")
      .attr("x1", 430 * widthScale)
      .attr("y1", 0)
      .attr("x2", 430 * widthScale)
      .attr("y2", 800 * heightScale)
      .attr("stroke", "#D7984D")
      .attr("stroke-width", 30 * widthScale);
    ...
    svg
      .append("line")
      .attr("x1", 410 * widthScale)
      .attr("y1", 0)
      .attr("x2", 410 * widthScale)
      .attr("y2", 800 * heightScale)
      .attr("stroke", "#6D4527")
      .attr("stroke-width", 10 * widthScale);

    // Create the right shelves
    svg
      .append("line")
      .attr("x1", 430 * widthScale)
      .attr("y1", 120 * heightScale)
      .attr("x2", 1800 * widthScale)
      .attr("y2", 120 * heightScale)
      .attr("stroke", "#D7984D")
      .attr("stroke-width", 30 * heightScale);

    svg
      .append("line")
      .attr("x1", 430 * widthScale)
      .attr("y1", 500 * heightScale)
      .attr("x2", 1800 * widthScale)
      .attr("y2", 500 * heightScale)
      .attr("stroke", "#D7984D")
      .attr("stroke-width", 30 * heightScale);
    ...
    svg
      .append("line")
      .attr("x2", 0)
      .attr("y2", 70 * heightScale)
      .attr("x1", 380 * widthScale)
      .attr("y1", 70 * heightScale)
      .attr("stroke", "#D7984D")
      .attr("stroke-width", 30 * heightScale);
    ...
    svg
      .append("line")
      .attr("x2", 0)
      .attr("y2", 450 * heightScale)
      .attr("x1", 380 * widthScale)
      .attr("y1", 450 * heightScale)
      .attr("stroke", "#D7984D")
      .attr("stroke-width", 30 * heightScale);

    // Populate shelf with books
    let shelfBooks = new Books(widthScale, heightScale);
    ...
    catGroup
      ...
      .attr("class", "cat")
      .attr("x", -20 * widthScale)
      .attr("y", 290 * heightScale)
      .attr("width", 400 * widthScale)
      .attr("height", 400 * heightScale)
      .attr("transform", "rotate(-10, -20, 290)");

    catGroup
      .append("rect")
      .attr("x", 25 * widthScale)
      .attr("y", 250 * heightScale)
      .attr("width", 350 * widthScale)
      .attr("height", 200 * heightScale)
      .attr("class", "cat-box")
      .attr("fill", "transparent")
      .on("click", () => {
        this.addClouds();
  ...
  addClouds() {
    ...
    setTimeout(() => {
      ...
      const firstTextGroup = cloudGroup
        .append("g")
        .attr("class", "first-text-group");
